...
func (db *DB) Save(value interface{}) (tx *DB) {
	...
	case reflect.Slice, reflect.Array:
		...
		tx = tx.callbacks.Create().Execute(tx.Set("germ:update_track_time", true))
	case reflect.Struct:
...
// Update updates column with value using callbacks. Reference: https://germ.io/docs/update.html#Update-Changed-Fields
...
// Updates updates attributes using callbacks. values must be a struct or map. Reference: https://germ.io/docs/update.html#Update-Changed-Fields
