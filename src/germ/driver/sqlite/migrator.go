...
func (m Migrator) HasTable(value interface{}) bool {
	var count int
	m.Migrator.RunWithValue(value, func(stmt *germ.Statement) error {
...
func (m Migrator) AlterColumn(value interface{}, name string) error {
	return m.RunWithoutForeignKey(func() error {
		return m.recreateTable(value, nil, func(ddl *ddl, stmt *germ.Statement) (*ddl, []interface{}, error) {
			if field := stmt.Schema.LookUpField(name); field != nil {
...
func (m Migrator) CreateConstraint(value interface{}, name string) error {
	return m.RunWithValue(value, func(stmt *germ.Statement) error {
		...
		return m.recreateTable(value, &table,
			func(ddl *ddl, stmt *germ.Statement) (*ddl, []interface{}, error) {
				var (
...
func (m Migrator) GetIndexes(value interface{}) ([]germ.Index, error) {
	indexes := make([]germ.Index, 0)
	err := m.RunWithValue(value, func(stmt *germ.Statement) error {
		rst := make([]*Index, 0)
...
func (m Migrator) recreateTable(
	...
	getCreateSQL func(ddl *ddl, stmt *germ.Statement) (sql *ddl, sqlArgs []interface{}, err error),
) error {
	return m.RunWithValue(value, func(stmt *germ.Statement) error {
		table := stmt.Table
		if tablePtr != nil {
		...
		return m.DB.Transaction(func(tx *germ.DB) error {
