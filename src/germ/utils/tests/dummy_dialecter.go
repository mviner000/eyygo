...
func (DummyDialector) Initialize(db *germ.DB) error {
...
func (DummyDialector) Migrator(*germ.DB) germ.Migrator {
	return nil
}

func (DummyDialector) BindVarTo(writer clause.Writer, stmt *germ.Statement, v interface{}) {
	writer.WriteByte('?')
}
