...
//
// [docs]: https://germ.io/docs/sql_builder.html#Clauses
...
//
// Use Select when you only want a subset of the fields. By default, germ will select all fields.
...
//
// [docs]: https://germ.io/docs/query.html#Conditions
...
//
//	func AmountGreaterThan1000(db *germ.DB) *germ.DB {
//	    return db.Where("amount > ?", 1000)
//	}
//
//	func OrderStatus(status []string) func (db *germ.DB) *germ.DB {
//	    return func (db *germ.DB) *germ.DB {
...
//
// [FirstOrCreate]: https://germ.io/docs/advanced_query.html#FirstOrCreate
// [FirstOrInit]: https://germ.io/docs/advanced_query.html#FirstOrInit
...
// By default, germ uses soft deletion, marking records as "deleted"
